          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="mx-auto mt-4 max-w-lg text-white/80">
                Now that you understand how ScholarTrack works, take the
                first step towards transforming your scholarship experience.
              </p>
              ...
              <p className="mt-6 text-sm text-white/60">
                Free for students &middot; University plans start at
                $49/month
              </p>
            </div>
          </div>
