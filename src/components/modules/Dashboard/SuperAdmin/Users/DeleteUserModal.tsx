// src/app/(dashboardLayout)/(superAdminRoutes)/super-admin/users-management/_components/DeleteUserModal.tsx
...
import { deleteUserAction } from "@/app/(dashboardLayout)/(superAdminRoutes)/super-admin/users-management/_actions";
      ...
      <DialogContent className="sm:max-w-sm p-0 overflow-hidden rounded-2xl border-border/40 bg-background/95 backdrop-blur-xl shadow-2xl">
        ...
        <div className="px-5 py-4 space-y-3">
          ...
          <div className="flex items-center gap-3 rounded-xl border border-border/50 bg-muted/10 p-3">
            <div className="flex h-9 w-9 shrink-0 items-center justify-center rounded-full bg-muted/50 text-sm font-black">
          ...
          <Alert className="border-amber-500/30 bg-amber-500/10 rounded-lg py-2.5">
            ...
            <AlertDescription className="text-amber-700 dark:text-amber-400 font-semibold ml-1.5 text-xs leading-relaxed">
              This will soft-delete the user, their role profile, and invalidate
              all active sessions. This cannot be easily reversed.
            </AlertDescription>
          </Alert>
